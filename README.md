...
<!-- HEADER SECTION -->
<img src="https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=1,12,20&height=180&text=Data%20Structures%20Algorithms&fontSize=60&fontColor=ffffff&fontAlignY=40&desc=Complete%20Mastery%20Roadmap&descAlignY=62&descSize=18" width="100%"/>

<br>

<br>

[![DSA Roadmap](https://img.shields.io/badge/🧠_DSA-Mastery_Roadmap-00C853?style=for-the-badge&labelColor=1a1a1a)](https://github.com/deveshpunjabi/dsa-roadmap)
[![100% Free](https://img.shields.io/badge/💯_100%25-Free_Resources-FF6B6B?style=for-the-badge&labelColor=1a1a1a)](https://github.com/deveshpunjabi/dsa-roadmap)
[![500+ Problems](https://img.shields.io/badge/📊_500+-Practice_Problems-4ECDC4?style=for-the-badge&labelColor=1a1a1a)](https://github.com/deveshpunjabi/dsa-roadmap)
[![Language Agnostic](https://img.shields.io/badge/🌐_Works_With-C++_|_Java_|_Python-9C27B0?style=for-the-badge&labelColor=1a1a1a)](https://github.com/deveshpunjabi/dsa-roadmap)
...
| 4 | [⚠️ Why This Roadmap?](#%EF%B8%8F-why-this-roadmap-exists) | Gap between college & industry |

### 📈 Learning Path
| # | Section | Description |
|:-:|---------|-------------|
| 5 | [🗺️ Complete Roadmap](#%EF%B8%8F-complete-learning-roadmap) | Visual learning journey |
| 6 | [🏗️ Phase 1: Foundation](#-phase-1-the-architects-foundation) | Complexity, bits, recursion |
...
| # | Section | Description |
|:-:|---------|-------------|
| 10 | [🛠️ Projects](#%EF%B8%8F-hands-on-projects) | 10+ practical projects |
...
> ⚠️ **CRITICAL DECISION** — Pick ONE language and master it.  Don't switch mid-journey! 
...
<img src="https://img.icons8.com/color/96/000000/c-plus-plus-logo.png" width="60"><br><br>
<h3>C++</h3>
...
<th width="33%" align="center">
<img src="https://img.icons8.com/color/96/000000/python--v1.png" width="60"><br><br>
<h3>Python</h3>
<a href="https://docs.python.org/3/tutorial/"><img src="https://img.shields.io/badge/Learn-Python-3776AB?style=for-the-badge&logo=python&logoColor=white"></a>
</th>
</tr>
<tr>
<td valign="top">
...
```mermaid
graph TD
    A[🏗️ Phase 1: Foundation<br/>3-4 weeks] --> B[📊 Phase 2: Linear Structures<br/>4-5 weeks]
    B --> C[🌳 Phase 3: Non-Linear Structures<br/>5-6 weeks]
    C --> D[🚀 Phase 4: Algorithm Design<br/>6-8 weeks]
    
    A1[⏱️ Complexity Analysis] --> A
    A2[🔢 Bit Manipulation] --> A
    A3[🔄 Recursion & Backtracking] --> A
    ...
    D1[💚 Greedy Algorithms] --> D
    D2[✂️ Divide & Conquer] --> D
    D3[🧮 Dynamic Programming] --> D
...
## 🏗️ Phase 1: The Architect's Foundation
...
<details>
<summary><strong>⏱️ Week 1-2: Time & Space Complexity Analysis</strong></summary>
...
| **O(2ⁿ)** | Exponential | Doubles each step | Recursive fibonacci |
...
flowchart LR
    ...
    style OR fill:#e3f2fd,stroke:#2196F3
    style XOR fill:#fff3e0,stroke:#FF9800
```
...
```mermaid
flowchart TD
    subgraph RECURSION["🔄 Recursion Structure"]
    ...
    style RECURSION fill:#f3e5f5,stroke:#9C27B0
```
...
```mermaid
flowchart LR
    subgraph PATTERNS["📋 Array/String Patterns"]
        A["🎯 Two Pointers"]
        B["🪟 Sliding Window"]
        C["➕ Prefix Sum"]
    ...
    A --> A1["Sorted arrays"]
    A --> A2["Pair finding"]
    A --> A3["Container problems"]
    
    B --> B1["Subarray problems"]
    B --> B2["Substring problems"]
    B --> B3["Window constraints"]
    
    C --> C1["Range queries"]
    C --> C2["Subarray sums"]
    
    D --> D1["Maximum subarray"]
    D --> D2["Contiguous sum"]
    
    style PATTERNS fill:#e3f2fd,stroke:#2196F3
```
...
flowchart LR
    subgraph SINGLY["Singly Linked List"]
        S1[Node] --> S2[Node] --> S3[Node] --> S4[NULL]
    end
    
    subgraph DOUBLY["Doubly Linked List"]
        D1[NULL] <--> D2[Node] <--> D3[Node] <--> D4[NULL]
    end
    
    subgraph CIRCULAR["Circular Linked List"]
        C1[Node] --> C2[Node] --> C3[Node] --> C1
    end
    
    style SINGLY fill:#e8f5e9,stroke:#4CAF50
    style DOUBLY fill:#e3f2fd,stroke:#2196F3
    style CIRCULAR fill:#fff3e0,stroke:#FF9800
```
...
flowchart LR
    ...
    style QUEUE fill:#e3f2fd,stroke:#2196F3
```
...
```mermaid
flowchart TD
    subgraph TREE["Binary Tree Example"]
        A((1)) --> B((2))
        A --> C((3))
        B --> D((4))
        B --> E((5))
...
flowchart TD
    ...
    style X1 fill:#2196F3,stroke:#1565C0,color:#fff
```
...
<details>
<summary><strong>🕸️ Week 13-15: Graphs</strong></summary>
...
> ⚠️ **CRITICAL PHASE** — This is where most students struggle.  Dynamic Programming appears in 30-40% of interview problems.  Master this phase to stand out! 
...
```mermaid
flowchart LR
    A["🎯 Problem"] --> B["Make Locally Optimal Choice"]
    B --> C{"More Choices?"}
    C -->|Yes| B
    C -->|No| D["✅ Global Solution"]
...
<details>
<summary><strong>✂️ Week 18: Divide and Conquer</strong></summary>
...
```mermaid
flowchart TD
    A["🎯 Original Problem"] --> B
    subgraph DIVIDE["1️⃣ DIVIDE"]
        B["Break into Subproblems"]
    end
    ...
    subgraph CONQUER["2️⃣ CONQUER"]
        C1 --> D1["Solve Recursively"]
        C2 --> D2["Solve Recursively"]
        C3 --> D3["Solve Recursively"]
    end
    
    subgraph COMBINE["3️⃣ COMBINE"]
        D1 --> E["Merge Solutions"]
        D2 --> E
        D3 --> E
    end
    ...
    style DIVIDE fill:#e8f5e9,stroke:#4CAF50
    style CONQUER fill:#e3f2fd,stroke:#2196F3
    style COMBINE fill:#fff3e0,stroke:#FF9800
```
...
### ⚠️ Why DP is Both Feared and Essential
...
```mermaid
flowchart TD
    subgraph FRAMEWORK["🧮 DP Problem-Solving Framework"]
        A["1️⃣ DEFINE STATE<br/>What info do I need for each subproblem?"]
        B["2️⃣ DEFINE RECURRENCE<br/>How do states relate to each other?"]
        C["3️⃣ DEFINE BASE CASE<br/>What are the trivial subproblems?"]
        D["4️⃣ DEFINE ANSWER<br/>Which state gives final answer?"]
        E["5️⃣ DETERMINE ORDER<br/>In what order to compute states?"]
    end
    
    A --> B --> C --> D --> E
    
    style FRAMEWORK fill:#f3e5f5,stroke:#9C27B0
```
...
<img src="https://img.icons8.com/color/48/000000/youtube-play.png" width="40"><br>
...
<td align="center" width="25%">
<img src="https://img.icons8.com/color/48/000000/code. png" width="40"><br>
...
| Step | Action |
|------|--------|
| 1️⃣ | Start with classic problems (Fibonacci, Knapsack) |
| 2️⃣ | Solve 10+ problems of EACH category |
| 3️⃣ | Focus on STATE DEFINITION |
| 4️⃣ | Write memoized recursion FIRST |
| 5️⃣ | Convert to bottom-up later |
| 6️⃣ | Review after 1 week |
...
### 1️⃣ 📊 Sorting Algorithm Visualizer
...
### 2️⃣ 🔢 Expression Evaluator

<img src="https://img.icons8.com/fluency/96/000000/calculator.png" width="60">
...
<img src="https://img.icons8.com/fluency/96/000000/zip.png" width="60">
...
<tr>
<td align="center">
<img src="https://img.icons8.com/color/30/000000/university.png"><br>
...
<tr>
<td align="center">
<img src="https://img.icons8.com/color/30/000000/youtube-play.png"><br>
...
<td align="center" width="20%">
<img src="https://img.icons8.com/color/48/000000/source-code.png" width="50"><br>
<strong><a href="https://codeforces.com/">Codeforces</a></strong><br>
<small>Competitive coding</small>
</td>
<td align="center" width="20%">
<img src="https://img.icons8.com/color/48/000000/GeeksforGeeks.png" width="50"><br>
<strong><a href="https://www.geeksforgeeks.org/">GeeksforGeeks</a></strong><br>
<small>Learning + practice</small>
</td>
<td align="center" width="20%">
<img src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/48/000000/external-hackerrank-is-a-technology-company-that-focuses-on-competitive-programming-logo-shadow-tal-revivo.png" width="50"><br>
<strong><a href="https://www.hackerrank.com/">HackerRank</a></strong><br>
<small>Structured paths</small>
</td>
<td align="center" width="20%">
<img src="https://img.icons8.com/color/48/000000/console.png" width="50"><br>
...
<tr>
<td align="center" width="25%">
<img src="https://img.icons8.com/color/48/000000/book.png" width="40"><br>
...
<tr>
<td align="center">
<img src="https://img.icons8.com/color/30/000000/visual-studio-code-2019.png"><br>
...
<tr>
<td align="center">
<img src="https://img.icons8.com/color/30/000000/c-plus-plus-logo.png"><br>
<strong>GCC/G++</strong>
</td>
<td>C++ compiler</td>
<td>✅ Free</td>
...
<tr>
<td align="center">
<img src="https://img.icons8.com/color/30/000000/java-coffee-cup-logo.png"><br>
<strong>JDK</strong>
</td>
...
<tr>
<td align="center">
<img src="https://img.icons8.com/color/30/000000/python--v1.png"><br>
...
<tr>
<td align="center">
<img src="https://img.icons8.com/color/30/000000/git.png"><br>
<strong>Git</strong>
</td>
...
| Step | Action | Time |
|------|--------|------|
| 1️⃣ | Read problem carefully | 2-3 min |
| 2️⃣ | Identify constraints | 1 min |
| 3️⃣ | Think before coding | 5-15 min |
| 4️⃣ | Start with brute force | - |
| 5️⃣ | Optimize using patterns | - |
| 6️⃣ | Code the solution | 10-20 min |
| 7️⃣ | Test with edge cases | 5 min |
...
flowchart TD
    ...
    F -->|Yes| G["BFS / DFS"]
    F -->|No| H{"Optimization?"}
    H -->|Yes| I{"Overlapping Subproblems? "}
    I -->|Yes| J["Dynamic Programming"]
    I -->|No| K["Greedy"]
    H -->|No| L["Brute Force / Backtracking"]
...
[![Star](https://img.shields.io/badge/⭐_Star_This_Repo-FFD700?style=for-the-badge)](https://github.com/deveshpunjabi/dsa-roadmap)
[![Share](https://img.shields.io/badge/📤_Share_With_Friends-4CAF50?style=for-the-badge)](https://github.com/deveshpunjabi/dsa-roadmap)
[![Fork](https://img.shields.io/badge/🍴_Fork_&_Contribute-2196F3?style=for-the-badge)](https://github.com/deveshpunjabi/dsa-roadmap/fork)
